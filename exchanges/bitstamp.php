...
class Bitstamp
{
	...
	{
			global $bitstamp;
			$this->key = $bitstamp['key'];
			$this->secret = $bitstamp['secret'];
			$this->client_id = $bitstamp['user'];
	}
	/**
	...
	*
	*/
	function usertransactions($offset="0",$limit="100",$sort="desc"){
		$usertransactions = $this->bitstamp_query('user_transactions', array('offset'=>$offset,'limit'=>$limit,'sort'=>$sort));
		$this->usertransactions = $usertransactions; // Another variable to contain it.
